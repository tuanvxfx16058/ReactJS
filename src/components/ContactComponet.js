...
HandleValidate(fistname, lastname, telnum, email){
  const errors={
    fistname: "",
    lastname: "",
    telnum: "",
...
if(this.state.touched.email&&email.split('').filter(x=>x==='@').length !==1)
  ...
  render() {
    const thongbao=this.HandleValidate(this.state.fistname, this.state.lastname, this.state.telnum, this.state.email)
